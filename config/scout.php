...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you may configure your TNTSearch settings. TNTSearch is a fully featured
    | full-text search engine which works out of the box with Laravel Scout.
    |
    */
    'tntsearch' => [
        'storage'  => storage_path('indices'), // İndeks dosyalarının saklanacağı dizin
        'fuzziness' => true, // Bulanık aramayı aktif eder
        'fuzzy' => [
            'prefix_length' => 0, // Önek uzunluğunu sıfıra düşürdüm
            'max_expansions' => 100, // Maksimum genişleme sayısını artırdım
            'distance' => 1 // Levenshtein mesafesini artırdıms
        ],
