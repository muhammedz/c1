...
class HeaderService
{
    ...
    public function getHeaderSettings()
    {
        ...
        return (object) [
            'logo_path' => $headerSettings->logo_path ? asset(ltrim($headerSettings->logo_path, '/')) : asset('images/logo-cankaya.png'),
            'secondary_logo_path' => $headerSettings->secondary_logo_path ? asset(ltrim($headerSettings->secondary_logo_path, '/')) : asset('images/simge.png'),
            'slogan_path' => $headerSettings->slogan_path ? asset(ltrim($headerSettings->slogan_path, '/')) : asset('images/slogan.png'),
            ...
            'mobile_logo_path' => $headerSettings->mobile_logo_path ? asset(ltrim($headerSettings->mobile_logo_path, '/')) : null,
        ];
    }
