...
@section('title', 'Yeni Çankaya Evi Ekle')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form action="{{ route('admin.cankaya-houses.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <!-- Sol Kolon -->
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="url" class="form-control @error('location_link') is-invalid @enderror" 
                                                           id="location_link" name="location_link" value="{{ old('location_link') }}"
