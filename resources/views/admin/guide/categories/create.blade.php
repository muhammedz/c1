...
@section('title', 'Yeni Rehber Kategorisi')

@section('content')
<div class="container-fluid px-4">
    <h1 class="mt-4">Yeni Rehber Kategorisi</h1>
        ...
        <div class="col-lg-8">
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-plus me-1"></i> Kategori Bilgileri
                </div>
                <div class="card-body">
                    @if(session('error'))
                    ...
                    <form action="{{ route('admin.guide-categories.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control @error('icon') is-invalid @enderror" 
                                       id="icon" name="icon" value="{{ old('icon') }}" placeholder="fas fa-map-marker-alt">
                                <button type="button" class="btn btn-outline-secondary" id="icon-preview">
                                    <i id="icon-display" class="{{ old('icon', 'fas fa-question') }}"></i>
                                </button>
                            </div>
