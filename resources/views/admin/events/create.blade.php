                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('location') is-invalid @enderror" id="location" name="location" value="{{ old('location') }}" placeholder="Örn: Konferans Salonu">
                                    @error('location')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="register_required" name="register_required" value="1" {{ old('register_required') === '1' ? 'checked' : '' }}>
                                ...
                                <div class="form-group register-settings" id="register-url-group">
                                    ...
                                    <input type="url" class="form-control @error('register_url') is-invalid @enderror" id="register_url" name="register_url" value="{{ old('register_url') }}" placeholder="https://...">
