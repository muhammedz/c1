...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="m-0 text-dark">Projeyi Düzenle: {{ $project->title }}</h1>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title', $project->title) }}" required autofocus>
                        @error('title')
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-2 p-2 bg-light border rounded">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <span class="text-primary fw-bold" id="slug-preview">{{ old('slug', $project->slug) }}</span>
                            </div>
                            <div class="small text-muted mt-1">
                                <i class="fas fa-info-circle me-1"></i> Slug:
                            </div>
                            <div class="input-group mt-1">
                                <input type="text" class="form-control form-control-sm @error('slug') is-invalid @enderror" id="slug" name="slug" value="{{ old('slug', $project->slug) }}" placeholder="Otomatik oluşturulur">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control @error('summary') is-invalid @enderror" id="summary" name="summary" rows="3" style="height: 100px;">{{ old('summary', $project->summary ?? '') }}</textarea>
                        @error('summary')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control tinymce @error('description') is-invalid @enderror" id="description" name="description" rows="10">{{ old('description', $project->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control @error('cover_image') is-invalid @enderror" id="filemanagersystem_image" name="cover_image" value="{{ old('cover_image', asset('storage/' . $project->cover_image)) }}" required>
                        ...
                        @enderror
                        <div id="filemanagersystem_image_preview" class="mt-2" style="display: {{ $project->cover_image ? 'block' : 'none' }};">
                            <img src="{{ asset($project->cover_image) }}" alt="Önizleme" class="img-thumbnail">
                        </div>
                        <div class="alert alert-warning mt-2" id="image-warning" style="display: {{ $project->cover_image ? 'none' : 'block' }};">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('filemanagersystem_image_alt') is-invalid @enderror" id="filemanagersystem_image_alt" name="filemanagersystem_image_alt" value="{{ old('filemanagersystem_image_alt', $project->filemanagersystem_image_alt ?? '') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('filemanagersystem_image_title') is-invalid @enderror" id="filemanagersystem_image_title" name="filemanagersystem_image_title" value="{{ old('filemanagersystem_image_title', $project->filemanagersystem_image_title ?? '') }}">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="card h-100">
                                            <div class="card-body p-2 text-center">
                                                <img src="{{ asset($image->image_path) }}" class="img-fluid rounded" style="max-height: 120px; margin: 0 auto;">
                                                <div class="mt-2">
                                                ...
                                                <small class="text-muted d-block mt-1">Sıra: {{ $image->order }}</small>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                        ...
                        @else
                            <div class="alert alert-info">
                                <i class="fas fa-info-circle me-1"></i> Henüz galeriye görsel eklenmemiş.
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="form-group">
                        <label>Yeni Galeri Görselleri <small class="text-muted">(En fazla 10 görsel)</small></label>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('meta_title') is-invalid @enderror" id="meta_title" name="meta_title" value="{{ old('meta_title', $project->meta_title ?? '') }}">
                        @error('meta_title')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control @error('meta_description') is-invalid @enderror" id="meta_description" name="meta_description" rows="3">{{ old('meta_description', $project->meta_description ?? '') }}</textarea>
