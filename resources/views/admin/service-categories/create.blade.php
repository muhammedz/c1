    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="card card-primary card-outline mb-4">
                ...
                <form action="{{ route('admin.service-categories.store') }}" method="POST" id="serviceCategoryForm">
                    @csrf
                    <div class="card-body">
                        @if(session('error'))
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('parent_id') is-invalid @enderror" id="parent_id" name="parent_id">
                                        ...
                                        @foreach($serviceCategories as $serviceCategory)
                                            <option value="{{ $serviceCategory->id }}" {{ old('parent_id') == $serviceCategory->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">
                                        Font Awesome ikon kodu (örn: fas fa-folder, fas fa-tools). 
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row text-center">
                        <div class="col-3 mb-3 icon-preview" data-icon="fas fa-tools">
                            <i class="fas fa-tools fa-2x mb-2"></i>
                            <div class="small">fa-tools</div>
                        </div>
                        <div class="col-3 mb-3 icon-preview" data-icon="fas fa-cogs">
                            <i class="fas fa-cogs fa-2x mb-2"></i>
                            <div class="small">fa-cogs</div>
                        </div>
                        <div class="col-3 mb-3 icon-preview" data-icon="fas fa-laptop">
                            <i class="fas fa-laptop fa-2x mb-2"></i>
                            <div class="small">fa-laptop</div>
                        </div>
                        <div class="col-3 mb-3 icon-preview" data-icon="fas fa-mobile-alt">
                            <i class="fas fa-mobile-alt fa-2x mb-2"></i>
                            <div class="small">fa-mobile-alt</div>
                        </div>
                        <div class="col-3 mb-3 icon-preview" data-icon="fas fa-paint-brush">
                            <i class="fas fa-paint-brush fa-2x mb-2"></i>
                            <div class="small">fa-paint-brush</div>
                        </div>
                        <div class="col-3 mb-3 icon-preview" data-icon="fas fa-code">
                            <i class="fas fa-code fa-2x mb-2"></i>
                            <div class="small">fa-code</div>
                        </div>
