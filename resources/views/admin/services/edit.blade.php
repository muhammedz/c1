                        ...
                        <div class="col-md-6 mb-2">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="hedef_kitleler[]" 
                                    ...
                                    {{ in_array($hedefKitle->id, $service->hedefKitleler->pluck('id')->toArray()) ? 'checked' : '' }}>
                                        ...
                                        <div class="topic-item d-flex align-items-center py-2 px-3 mb-1 rounded hover-bg-light">
                                            <div class="form-check mb-0 w-100">
                                                <label class="d-flex align-items-center gap-2">
                                                    <input type="checkbox" name="service_topic_ids[]" value="{{ $topic->id }}" class="form-check-input me-1" {{ in_array($topic->id, old('service_topic_ids', $service->serviceTopics->pluck('id')->toArray())) ? 'checked' : '' }}>
                                                    @if($topic->icon)
