                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('direct_link') is-invalid @enderror" id="direct_link" name="direct_link" value="{{ old('direct_link') }}" placeholder="Örn: /hakkimizda veya https://example.com">
                            @error('direct_link')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
