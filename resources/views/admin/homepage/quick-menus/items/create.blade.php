...
@section('title', $category->name . ' - Yeni Menü Öğesi Ekle')

@section('content_header')
    <div class="d-flex justify-content-between">
        <h1>{{ $category->name }} - Yeni Menü Öğesi Ekle</h1>
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Yeni Menü Öğesi Ekle</h3>
        ...
        <form action="{{ route('admin.homepage.quick-menus.items.store', $category->id) }}" method="POST" id="menu-item-form">
            @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('url') is-invalid @enderror" id="url" name="url" value="{{ old('url') }}" required placeholder="Örn: /services veya https://example.com">
                            @error('url')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i id="selected-icon" class="{{ old('icon', 'fas fa-link') }}"></i></span>
                                </div>
                                <input type="text" class="form-control @error('icon') is-invalid @enderror" id="icon" name="icon" value="{{ old('icon', 'fas fa-link') }}" placeholder="İkon sınıfı örn: fas fa-link">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                <div id="icon-preview" class="py-4">
                                    <i class="{{ old('icon', 'fas fa-link') }} fa-3x"></i>
                                    <div class="mt-2">{{ old('title', 'Menü Öğesi') }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
