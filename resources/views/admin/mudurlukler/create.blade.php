...
@section('title', 'Yeni Müdürlük Ekle')
...
<div class="container-fluid">
    ...
    <form action="{{ route('admin.mudurlukler.store') }}" method="POST" enctype="multipart/form-data" id="mudurluk-form">
        @csrf
                    ...
                    <div class="card-body">
                        <div class="mb-4">
                            ...
                            <textarea class="form-control tinymce @error('gorev_tanimi_ve_faaliyet_alani') is-invalid @enderror" 
                                      id="gorev_tanimi_ve_faaliyet_alani" name="gorev_tanimi_ve_faaliyet_alani">{{ old('gorev_tanimi_ve_faaliyet_alani') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control tinymce @error('yetki_ve_sorumluluklar') is-invalid @enderror" 
                                      id="yetki_ve_sorumluluklar" name="yetki_ve_sorumluluklar">{{ old('yetki_ve_sorumluluklar') }}</textarea>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('order_column') is-invalid @enderror" 
                                   id="order_column" name="order_column" value="{{ old('order_column', 0) }}" min="0">
                            @error('order_column')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="category-list" style="max-height: 300px; overflow-y: auto; border: 1px solid #dee2e6; border-radius: 4px; padding: 10px;">
                                ...
                                <div class="form-check mb-2">
                                    <input type="checkbox" name="service_category_ids[]" value="{{ $category->id }}" 
                                           ...
                                           {{ in_array($category->id, old('service_category_ids', [])) ? 'checked' : '' }}>
                ...
                <div class="card">
                    <div class="card-body">
                        <button type="submit" class="btn btn-primary btn-lg w-100">
                            <i class="fas fa-save"></i> Müdürlük Kaydet
                        </button>
                    </div>
                </div>
            </div>
