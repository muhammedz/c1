{{--
    Haber Paylaşım Bileşeni - Minimal Tasarım
    
    Bu bileşen, haber sayfalarında minimal sosyal medya paylaşım butonları ve PDF indirme 
    özelliğini sağlar.
    ...
    - $news: Haber modeli (News model instance)
--}}

<div class="mt-8 pt-6 border-t border-gray-200">
    <!-- Minimal Paylaşım Butonları -->
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-3">
            ...
            <!-- PDF İndir -->
            <a href="{{ route('news.pdf.download', $news->slug) }}"
