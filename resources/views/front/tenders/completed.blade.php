...
@section('title', 'Tamamlanan İhaleler')
@section('meta_description', 'Tamamlanan ihaleler listesi')
        ...
        <div class="col-md-9">
            ...
            <div class="tender-nav mb-4">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('tenders.completed') }}">Tamamlanan İhaleler</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('tenders.cancelled') }}">İptal Edilen İhaleler</a>
                    </li>
                </ul>
            </div>
            ...
            @else
                <div class="alert alert-info">
                    Tamamlanan ihale bulunmamaktadır.
                </div>
            @endif
        </div>
