            ...
            <div class="text-center pt-4">
                ...
                <div class="flex justify-center items-center mb-4">
                    @if($footerSettings && $footerSettings->logo)
                        <img src="{{ $footerSettings->logo_url }}" alt="Logo" class="object-contain" style="width: 210px; height: 93px;">
                    @else
                        <div class="bg-white rounded-full flex items-center justify-center" style="width: 210px; height: 93px;">
                            <svg class="text-[#065a28]" style="width: 140px; height: 62px;" fill="currentColor" viewBox="0 0 24 24">
