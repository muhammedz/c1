                ...
                <div class="mb-6">
                    <div class="flex justify-center items-center mb-4">
                        @if($footerSettings && $footerSettings->logo)
                            <img src="{{ $footerSettings->logo_url }}" alt="{{ $footerSettings->company_name }}" class="w-24 h-24 object-contain">
                        @else
                            <div class="w-24 h-24 bg-white rounded-full flex items-center justify-center">
                                <svg class="w-16 h-16 text-[#065a28]" fill="currentColor" viewBox="0 0 24 24">
